...
public class OrderAggregationServiceLRTest {
    public static void main(String[] args) throws Exception {
        ...
        inputSpecs.put(AppConfig.ORDER_AGGREGATION_TOPIC_NAME, ConsumerConfig.builder().schemaType("AVRO").build());
        ...
        LocalRunner localRunner = LocalRunner.builder()
                ...
                .stateStorageServiceUrl(AppConfig.STATE_STORAGE_SERVICE_URL)
