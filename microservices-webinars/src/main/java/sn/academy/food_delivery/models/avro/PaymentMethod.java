...
public class PaymentMethod extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static sn.academy.food_delivery.models.avro.PaymentMethod.Builder newBuilder() {
    return new sn.academy.food_delivery.models.avro.PaymentMethod.Builder();
  }
   ...
   * @return A new PaymentMethod RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.PaymentMethod.Builder newBuilder(sn.academy.food_delivery.models.avro.PaymentMethod.Builder other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.PaymentMethod.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.PaymentMethod.Builder(other);
    }
  }
   ...
   * @return A new PaymentMethod RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.PaymentMethod.Builder newBuilder(sn.academy.food_delivery.models.avro.PaymentMethod other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.PaymentMethod.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.PaymentMethod.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentMethod>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.PaymentMethod.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.PaymentMethod other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentMethod.Builder setType(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentMethod.Builder clearType() {
      type = null;
