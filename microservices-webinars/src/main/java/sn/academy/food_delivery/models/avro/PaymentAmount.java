...
public class PaymentAmount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4731078551601495815L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentAmount\",\"namespace\":\"sn.academy.food_delivery.models.avro\",\"fields\":[{\"name\":\"food_total\",\"type\":\"float\"},{\"name\":\"tax\",\"type\":\"float\"},{\"name\":\"total\",\"type\":\"float\"}]}");
   ...
   */
  public static sn.academy.food_delivery.models.avro.PaymentAmount.Builder newBuilder() {
    return new sn.academy.food_delivery.models.avro.PaymentAmount.Builder();
  }
   ...
   * @return A new PaymentAmount RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.PaymentAmount.Builder newBuilder(sn.academy.food_delivery.models.avro.PaymentAmount.Builder other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.PaymentAmount.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.PaymentAmount.Builder(other);
    }
  }
   ...
   * @return A new PaymentAmount RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.PaymentAmount.Builder newBuilder(sn.academy.food_delivery.models.avro.PaymentAmount other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.PaymentAmount.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.PaymentAmount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentAmount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.PaymentAmount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.PaymentAmount other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.food_total)) {
        this.food_total = data().deepCopy(fields()[0].schema(), other.food_total);
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentAmount.Builder setFoodTotal(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentAmount.Builder clearFoodTotal() {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentAmount.Builder setTax(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentAmount.Builder clearTax() {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentAmount.Builder setTotal(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.PaymentAmount.Builder clearTotal() {
