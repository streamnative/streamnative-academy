...
public class MenuItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static sn.academy.food_delivery.models.avro.MenuItem.Builder newBuilder() {
    return new sn.academy.food_delivery.models.avro.MenuItem.Builder();
  }
   ...
   * @return A new MenuItem RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.MenuItem.Builder newBuilder(sn.academy.food_delivery.models.avro.MenuItem.Builder other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.MenuItem.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.MenuItem.Builder(other);
    }
  }
   ...
   * @return A new MenuItem RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.MenuItem.Builder newBuilder(sn.academy.food_delivery.models.avro.MenuItem other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.MenuItem.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.MenuItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MenuItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.MenuItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.MenuItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.item_id)) {
        this.item_id = data().deepCopy(fields()[0].schema(), other.item_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder clearItemId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder setItemName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder clearItemName() {
      item_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.MenuItem.Builder clearPrice() {
