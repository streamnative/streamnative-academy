...
public class CreditCard extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public sn.academy.food_delivery.models.avro.CardType card_type;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: card_type = (sn.academy.food_delivery.models.avro.CardType)value$; break;
   ...
   */
  public sn.academy.food_delivery.models.avro.CardType getCardType() {
    return card_type;
  }
   ...
   */
  public void setCardType(sn.academy.food_delivery.models.avro.CardType value) {
   ...
   */
  public static sn.academy.food_delivery.models.avro.CreditCard.Builder newBuilder() {
    return new sn.academy.food_delivery.models.avro.CreditCard.Builder();
  }
   ...
   * @return A new CreditCard RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.CreditCard.Builder newBuilder(sn.academy.food_delivery.models.avro.CreditCard.Builder other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.CreditCard.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.CreditCard.Builder(other);
    }
  }
   ...
   * @return A new CreditCard RecordBuilder
   */
  public static sn.academy.food_delivery.models.avro.CreditCard.Builder newBuilder(sn.academy.food_delivery.models.avro.CreditCard other) {
    if (other == null) {
      return new sn.academy.food_delivery.models.avro.CreditCard.Builder();
    } else {
      return new sn.academy.food_delivery.models.avro.CreditCard.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CreditCard>
    ...
    private sn.academy.food_delivery.models.avro.CardType card_type;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.CreditCard.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(sn.academy.food_delivery.models.avro.CreditCard other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.card_type)) {
        this.card_type = data().deepCopy(fields()[0].schema(), other.card_type);
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder setCardType(sn.academy.food_delivery.models.avro.CardType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder clearCardType() {
      card_type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder setAccountNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder clearAccountNumber() {
      account_number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder setBillingZip(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder clearBillingZip() {
      billing_zip = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder setCcv(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sn.academy.food_delivery.models.avro.CreditCard.Builder clearCcv() {
      ccv = null;
    ...
    public CreditCard build() {
      try {
        ...
        record.card_type = fieldSetFlags()[0] ? this.card_type : (sn.academy.food_delivery.models.avro.CardType) defaultValue(fields()[0]);
